...
export default function ProfileGeneralPlatformCard({
  platform,
  artist,
  pendingLinks,
  openSubPanel,
          ...
          {(() => {
            ...
            return (
              <>
                ...
                {/* 6. Graph icon followed by clicks count */}
                {!isMobileViewport && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#94a3b8', fontSize: '12px', cursor: 'default' }}>
                    ...
                    <span>{linkItem?.clicks ?? 0} clicks</span>
                  </div>
                )}
              </>
            );
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', cursor: 'pointer' }} onClick={() => handleUpdateLinkPrioritize(platform.id, 'animate', currentAnimationType, linkItem?._id)}>
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                      ...
                      <div style={{ textAlign: 'left' }}>
                        ...
                        <div style={{ fontSize: '11px', color: '#8e8e93', marginTop: '2px' }}>Apply a motion effect to this link.</div>
                      </div>
                    </div>
                    <div style={{
                      width: '24px',
