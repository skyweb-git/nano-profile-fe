...
export default function ProfileFounderOnboardingWizard({
  onboardingStep,
      ...
      <div className="profile-login-card profile-choice-card general-onboarding-card">
        ...
        {onboardingStep === 1 && (
          <div className="onboarding-step fade-in">
            ...
            <p className="onboarding-subtitle">Personalize your founder &amp; venture identity</p>
            <div className="onboarding-fields">
              ...
              <div className="onboarding-field">
                <label>Startup Domain / Industry <span className="onboarding-required-star">*</span></label>
                <input
                  type="text"
                  className="onboarding-input"
              ...
              <div className="onboarding-field">
                <label>Founder Role / Experience</label>
                <input
                  type="text"
                  className="onboarding-input"
                  value={formData.experience}
                  onChange={e => setFormData(prev => ({ ...prev, experience: e.target.value }))}
                  placeholder="e.g. Co-Founder &amp; CEO, 4+ years"
                />
              </div>
            ...
            <button className="onboarding-btn-primary" onClick={handleOnboardingNext} disabled={!isFounderStep1Valid}>
              Next Step →
            </button>
          </div>
        )}

        {/* ── STEP 2: DIGITAL PLATFORMS ── */}
        {onboardingStep === 2 && (
          <div className="onboarding-step fade-in">
            <h2>Connect Your Digital World</h2>
            <p className="onboarding-subtitle">Link your startup, LinkedIn, Twitter, and other platforms</p>
            <div className="onboarding-fields">
              {!isOnboardingSelectorOpen ? (
                <>
        ...
        {onboardingStep === 3 && (
          <div className="onboarding-step fade-in">
            ...
            <p className="onboarding-subtitle">Upload your profile image &amp; vision</p>
            ...
            <div className="onboarding-fields" style={{ marginTop: '1.5rem' }}>
              <div className="onboarding-field">
                <label>Founder Bio &amp; Vision</label>
                <textarea
                  className="onboarding-textarea"
                  value={formData.bio}
                  onChange={e => setFormData(prev => ({ ...prev, bio: e.target.value }))}
                  placeholder="Tell us about yourself, your mission, and the venture you are building..."
                  rows={3}
                />
              </div>
            </div>
